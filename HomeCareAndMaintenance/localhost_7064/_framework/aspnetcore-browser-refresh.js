setTimeout(async function () {
  ...
  const webSocketUrls = 'wss://localhost:44380/HomeCareWebsite/,ws://localhost:61438/HomeCareWebsite/'.split(',');
  const sharedSecret = await getSecret('');
  let connection;
